...
CREATE TABLE `forms` (
  ...
  `supervisortitle` varchar(100) NOT NULL,
  `supervisoremail` varchar(45) NOT NULL,
  `supervisorphone` varchar(45) NOT NULL,
...
CREATE TABLE `hours` (
  ...
  `volunteerrole` varchar(45) NOT NULL,
